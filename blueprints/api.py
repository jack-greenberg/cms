...
register_api(api, SiteAPI, 'site_api', '/siteData/', pk='type', pk_type='string')
register_api(api, PostAPI, 'post_api', '/posts/', pk='post_id', pk_type='string')
register_api(api, ContentAPI, 'content_api', '/content/', pk='content_id', pk_type='string')
register_api(api, PageAPI, 'page_api', '/pages/', pk='page_name', pk_type='string')
