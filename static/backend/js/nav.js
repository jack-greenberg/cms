                    ...
                    <li>
                        ...
                        <ul>
                            <PageContext.Consumer>
                                {context => (
                                    <React.Fragment>
                                        {Object.keys(context).map((page, index) => <NavLink to={"/pages/" + context[page].name.toLowerCase().replace(/ /, "_")} activeClassName="active" activeStyle={{ fontWeight: 'bold' }} exact>{context[page].name}</NavLink>)}
                                    </React.Fragment>
                                )}
                            </PageContext.Consumer>
                        </ul>
